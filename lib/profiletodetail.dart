...
class DetailPage extends StatefulWidget {
  DetailPage({ Key key, this.data, this.user}) : super(key: key);
  final data;
  final user;
  @override
      ...
      builder: (context, product) {
        ...
        return StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, userData) {
            ...
            DocumentSnapshot snapTemp = _getUserExist(context, userData.data.documents, widget.user);
                              ...
                              children: <Widget>[
                                IconButton(
                                    ...
                                    onPressed: () {
                                      final snackBar1 = SnackBar(
                                        ...
                                        action: SnackBarAction(
                                          ...
                                          onPressed: () {
                                            ...
                                            Firestore.instance.collection('user').document(widget.user).updateData({
                                              "likedCafe": userTemp,
                                            }).then((result) => {}).catchError((err) => print(err));
                                          },
                                        ),
                                      ...
                                      if (!record.likedUsers.contains(widget.user)) {
                                        List<dynamic> temp = [];
                                        record.likedUsers.forEach((element) {
                                          temp.add(element);
                                        });
                                        temp.add(widget.user);
